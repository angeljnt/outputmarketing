...
const faqs = [
  ...
  { q: "Do you run paid social or Google ads?", a: "No. We don't run paid. If that's what you need, we'll tell you who does it well. What we do — influencer programs, content, LinkedIn, SEO — we do without the waste that comes from spreading across everything." },
    ...
    <>
      ...
      <SectionWrapper className="!py-8 border-y border-border">
        <div className="container-default">
          ...
          <div className="mt-6 text-center space-y-1">
            ...
            <p className="text-[13px] text-muted-foreground">B2B fintech funding announcement: 855,000 impressions · 3.40% engagement</p>
          </div>
        </div>
      </SectionWrapper>
      ...
      <SectionWrapper>
        <div className="container-default">
          ...
          <p className="text-body-lg text-muted-foreground mb-10">All of them start the same way — with a 30-day pilot so you can see the work before you commit.</p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-surface p-6 md:p-8 flex flex-col">
              ...
              <Link to="/services/social-media" className="text-sm font-medium hover:opacity-60 transition-opacity mt-auto">Learn more →</Link>
            </div>
            {/* Engine */}
            <div className="bg-surface p-6 md:p-8 flex flex-col relative">
              ...
              <Link to="/services/content-marketing" className="text-sm font-medium hover:opacity-60 transition-opacity mt-auto">Learn more →</Link>
            </div>
            {/* Program */}
            <div className="bg-surface p-6 md:p-8 flex flex-col">
              <h3 className="text-h3 mb-1">Program</h3>
              <p className="text-body font-semibold mb-3">$5,000/month</p>
              <p className="text-body text-muted-foreground mb-4">Your first influencer program. Or the one that actually works this time. 5–10 qualified creators/month, strategy, execution, ROI measurement, executive report.</p>
              <p className="text-caption mb-4">For: B2B SaaS and DTC brands ready to build pipeline through creators.</p>
              <Link to="/services/influencer-marketing" className="text-sm font-medium hover:opacity-60 transition-opacity mt-auto">Learn more →</Link>
            </div>
          </div>
          ...
          <p className="text-body text-muted-foreground text-center mt-8">
            ...
            <Link to="/pricing" className="font-medium text-foreground hover:opacity-60 transition-opacity">See pricing →</Link>
          </p>
        </div>
      </SectionWrapper>
      ...
      <SectionWrapper className="bg-surface-alt">
        <div className="container-narrow">
          ...
          <div className="space-y-6 text-body-lg text-muted-foreground">
            ...
            <p>What we do — influencer programs, content strategy, LinkedIn, SEO — we do at a level most agencies can't match precisely because we're not spread thin.</p>
        ...
        <div className="container-default">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-body text-muted-foreground">We start with 30 days. You see the quality of the work. We learn your product, your ICP, and your voice. $1,500–$2,000, no strings attached.</p>
            </div>
            <div>
      ...
      <section className="bg-dark text-dark-text section-padding">
        <div className="container-narrow text-center">
          ...
          <p className="text-body-lg text-dark-muted mb-8">$1,500–$2,000. Full audit of your current presence. A strategic roadmap. Two to three weeks of live execution so you can see exactly what working with us looks like.</p>
          ...
          <Link to="/pricing" className="text-sm text-dark-muted hover:text-dark-text transition-colors mt-2 inline-block">See full pricing →</Link>
        </div>
      </section>
